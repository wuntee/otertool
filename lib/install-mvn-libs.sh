...
mvn install:install-file -Dfile=ddms/ddms-r17.jar -DgroupId=com.android.ddms -DartifactId=ddms -Dversion=r17 -Dpackaging=jar
mvn install:install-file -Dfile=ddms/ddmlib-r17.jar -DgroupId=com.android.ddmlib -DartifactId=ddmlib -Dversion=r17 -Dpackaging=jar
